                ...
                { pathName !== '/contacts' ? 
                    <div className="flex flex-col-reverse lg:flex-row justify-between items-center bg-gray_100 py-4 px-4 sm:py-6 sm:px-12 my-6 md:my-10 lg:my-[60px] rounded-lg font-Mon">
                        ...
                        <div className="max-w-[693px] w-[100%] flex flex-col gap-4">
                            ...
                            <a className="block w-full py-2 md:py-4 bg-gray_300 text-center rounded-lg font-semibold text-base md:text-xl" href="tel:77005553535">{t('footer.phone_text')}</a>
                            <a className="block w-full py-2 md:py-4 bg-gray_300 text-center rounded-lg font-semibold text-base md:text-xl" href="mailto:test@test.com">Email</a>
                        </div>
                    </div> : ''
                }
                        ...
                        <div className="flex items-start md:items-center gap-[30px]">
                            <Link href="/" className="w-[30px] h-[30px] relative block">
                                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
                                    <path d="M16.7732 9.82177C21.0455 7.93361 25.083 5.7683 26.7089 0.571533H0V27.4215H4.66073C4.66073 15.2957 11.1008 12.3249 16.7732 9.82177Z" fill="#D1D5DB"/>
                                    <path d="M17.7576 11.6925C12.1665 14.161 6.80127 16.1617 6.80127 27.4214H28.0004V3.55957C25.2906 8.12406 21.6777 9.96891 17.7576 11.6925Z" fill="#D1D5DB"/>
                                </svg>
                            </Link>
                            <nav>
                                <ul className="grid grid-cols-2 sm:flex flex-wrap gap-1 md:gap-10 text-base font-noraml font-Int">
                                    {
                                        navigationPath.map( (route) => {
                                            return (
                                            <li key={route.path}>
                                                <Link href={route.path} className={pathName == route.path ? 'text-gray_900':'text-[gray]'}>
                                                    {t(route.text)}
                                                </Link>
                                            </li>
                                            )
