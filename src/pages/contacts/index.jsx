...
const Contacts = ({}) => {
    ...
    return (
        <>
            ...
            <section className="container flex flex-wrap items-center justify-between py-16 md:py-24">
                <div className="mb-16 md: mb-0">
                    ...
                    <h4 className="text-gray_500 text-base mb-6">
                        ...
                        Аль-Фараби, 108А, офис 5, 6 этаж
                    </h4>
                    <a className="flex items-center gap-3 mb-3 text-base text-gray_500" href="tel:77005553535">
                        ...
                        <span>+7 (727) 232 08 08</span>
                    </a>
                    <a className="flex items-center gap-3 mb-3 text-base text-gray_500" href="mailto:test@test.com">
                ...
                <div className="w-[100%] sm:w-[340px] md:w-[450px] smd:w-[480px] lg:w-[638px] xl:w-[688px] h-[418px] mt-16 md: mt-0">
